...
public class EmployeeWageCalculation {
	...
	public void calculateCompanyEmployeeWage() {
		for(int index=0;index<noOfCompany;index++) {
			companyEmployeeWageArray[index].setTotalEmpWage(calculateEmployeeWage(companyEmployeeWageArray[index]));
			System.out.println(companyEmployeeWageArray[index]);
		}
	}

	public int calculateEmployeeWage(CompanyEmployeeWage companyEmpWage) {
	...
	public static void main(String[] args) {
		...
		EmployeeWageCalculation empWageCalculator = new EmployeeWageCalculation();
		empWageCalculator.addCompanyEmpWage("TCS", 20, 6, 10);
		empWageCalculator.addCompanyEmpWage("WIPRO", 10, 5, 20);	
		empWageCalculator.addCompanyEmpWage("INFOSYS", 10, 5, 20);
